...
class GreenlineBFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stationList = resources.getStringArray(R.array.gl_bostoncollege_parkst)
        val stationMap: Map<String, String> = resources.getStringArray(R.array.gl_bostoncollege_parkst)
            .zip(resources.getStringArray(R.array.gl_bostoncollege_parkst_id))
            .toMap()
