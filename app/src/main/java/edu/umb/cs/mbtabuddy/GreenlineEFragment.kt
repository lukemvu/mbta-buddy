...
class GreenlineEFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stationList = resources.getStringArray(R.array.gl_heathst_lechmere)
        val stationMap: Map<String, String> = resources.getStringArray(R.array.gl_heathst_lechmere)
            .zip(resources.getStringArray(R.array.gl_heathst_lechmere_id))
            .toMap()
