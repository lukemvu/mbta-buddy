...
class OrangelineFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stationList = resources.getStringArray(R.array.ol_oakgrove_foresthills)
        val stationMap: Map<String, String> = resources.getStringArray(R.array.ol_oakgrove_foresthills)
            .zip(resources.getStringArray(R.array.ol_oakgrove_foresthills_id))
            .toMap()
        val stationColor: List<Int> = listOf(
            R.drawable.ic_ol_stop_top,
            R.drawable.ic_ol_stop_middle,
            R.drawable.ic_ol_stop_bottom
        )
