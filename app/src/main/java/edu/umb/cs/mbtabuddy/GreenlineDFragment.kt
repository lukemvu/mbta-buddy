...
class GreenlineDFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stationList = resources.getStringArray(R.array.gl_riverside_govtcentr)
        val stationMap: Map<String, String> = resources.getStringArray(R.array.gl_riverside_govtcentr)
            .zip(resources.getStringArray(R.array.gl_riverside_govtcentr_id))
            .toMap()
