...
class RedlineAshmontFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stationList = resources.getStringArray(R.array.rl_alewife_ashmont)
        val stationMap: Map<String, String> = resources.getStringArray(R.array.rl_alewife_ashmont)
            .zip(resources.getStringArray(R.array.rl_alewife_ashmont_id))
            .toMap()
